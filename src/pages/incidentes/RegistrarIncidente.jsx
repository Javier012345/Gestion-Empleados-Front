            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm">
                ...
                <form className="space-y-4">
                    ...
                    <div className="mt-8 pt-4 border-t dark:border-gray-700 flex justify-end gap-3">
                        <Link to="/incidentes" className="px-4 py-2 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">Cancelar</Link>
                        <button type="submit" className="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">Guardar Incidente</button>
                    </div>
                </form>
            </div>
        </div>
