...
const mockRecibos = {
    1: [
        { id: 1, fecha_emision: "2023-10-15", periodo: "2023-09", ruta_pdf: "/recibos/recibo_1_09_2023.pdf", ruta_imagen: null },
        { id: 2, fecha_emision: "2023-09-15", periodo: "2023-08", ruta_pdf: "/recibos/recibo_1_08_2023.pdf", ruta_imagen: "/recibos/recibo_1_08_2023.jpg" },
    ],
    2: [
        { id: 3, fecha_emision: "2023-10-15", periodo: "2023-09", ruta_pdf: "/recibos/recibo_2_09_2023.pdf", ruta_imagen: null },
    ]
};
...
const VerRecibosEmpleado = () => {
    ...
    useEffect(() => {
        const employeeRecibos = mockRecibos[id] || [];
        setRecibos(employeeRecibos);
        const years = [...new Set(employeeRecibos.map(r => new Date(r.fecha_emision).getFullYear()))];
