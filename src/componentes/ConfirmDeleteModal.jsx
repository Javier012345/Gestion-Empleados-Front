    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={onClose}>
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md p-6 m-4 text-center" onClick={e => e.stopPropagation()}>
                ...
                <h2 className="text-xl font-semibold mt-4">Eliminar Empleado</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                    ¿Estás seguro de que deseas eliminar a <strong>{employeeName}</strong>? Esta acción no se puede deshacer.
                </p>
